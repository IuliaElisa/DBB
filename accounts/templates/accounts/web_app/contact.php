...
<h2 style="padding-left:5px; padding-right:5px; font-family:Monospace;text-align:center; background-image:url('/static/images/2.png'); border-radius:10px;  background-size: cover;
